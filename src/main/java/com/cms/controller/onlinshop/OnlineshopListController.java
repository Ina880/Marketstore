package com.cms.controller.onlinshop;
...
import com.cms.form.onlineshop.OnlineShopListForm;
 ...
 */
@Controller
@RequestMapping(value = "/onlineshop/onlineshoplist")//定義url跟controller 的action對應
public class OnlineshopListController extends ControllerBase {
private List<CmsEmployeeBean> lst;
	...
	public String init(Model model, HttpServletRequest request) {
			...
			OnlineShopListForm form = new OnlineShopListForm();
...
//			
		...
		return "/onlineshop/onlineshoplist";
	}
}
//	/**
//	 * メニュー画面初期化
...
//	public String select(@ModelAttribute("form") OnlineShopListForm form, Model model, HttpServletRequest request) {
//		try {
//			service.select(form);
//			
